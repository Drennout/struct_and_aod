...
//      тест сжатия файла
    ...
    private static void fileCompressTest() {
        try {
            ...
            String content = new String(Files.readAllBytes(Paths.get(".\\src\\text-file.txt")));
            ...
            File file = new File(".\\src\\aod\\practice15\\compressed.txt");
            ...
            Files.write(Paths.get(".\\src\\aod\\practice15\\decompressed.txt"), decoded.getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
